...
const MonthlyDataForm = ({
  ...
  return (
    <ChakraProvider>
    <Stack spacing={4} p={4} borderRadius="md" boxShadow="md" bg="white" className='outline mt-3 ml-3 mr-3 flex flex-col items-center justify-center w-[30%] h-[22%] bg-amber-100'>
